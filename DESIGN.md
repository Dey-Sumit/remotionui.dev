...
colors:
  dark:
    ...
    danger-hover: "#E1544E"
    danger-soft: "rgba(219, 59, 58, 0.15)"
    danger-soft-foreground: "#EB786F"
    danger-soft-hover: "rgba(219, 59, 58, 0.2)"
    ...
    success-hover: "#18B65F"
    success-soft: "rgba(0, 202, 103, 0.12)"
    success-soft-foreground: "#72D991"
    success-soft-hover: "rgba(0, 202, 103, 0.16)"
    ...
    warning-hover: "#DDA64B"
    warning-soft: "rgba(246, 184, 78, 0.12)"
    warning-soft-foreground: "#F9CB85"
    warning-soft-hover: "rgba(246, 184, 78, 0.16)"
  light:
    ...
    danger-foreground: "#FCFCFC"
    danger-hover: "#FF554D"
    danger-soft: "rgba(255, 56, 54, 0.15)"
    danger-soft-foreground: "#A43530"
    danger-soft-hover: "rgba(255, 56, 54, 0.2)"
    ...
    success-foreground: "#18181B"
    success-hover: "#18B65F"
    success-soft: "rgba(0, 202, 103, 0.15)"
    success-soft-foreground: "#297847"
    success-soft-hover: "rgba(0, 202, 103, 0.2)"
    surface-foreground: "#18181B"
    surface-hover: "#EAEAEA"
    surface-secondary-foreground: "#18181B"
    surface-tertiary-foreground: "#18181B"
    warning-foreground: "#18181B"
    warning-hover: "#DB9626"
    warning-soft: "rgba(244, 166, 30, 0.15)"
    warning-soft-foreground: "#85602D"
    warning-soft-hover: "rgba(244, 166, 30, 0.2)"
typography:
  xs:
    fontFamily: "Inter"
    fontSize: "12px"
...
| `muted` | `#707276` | `#9EA0A4` | `Light: oklch(55.17% 0.0060 264.51); Dark: oklch(70.50% 0.0060 264.51)` | `--muted` | `text-muted` | Secondary text color for less prominent content like placeholders and captions. |
...
| `danger` | `#FF3836` | `#DB3B3A` | `Light: oklch(65.32% 0.2342 27.02); Dark: oklch(59.40% 0.1979 25.91)` | `--danger` | `Button variant="danger"` or `text-danger` for destructive states | Represents destructive, irreversible, or critical actions and states. |
| `success` | `#00CA67` | `#00CA67` | `oklch(73.29% 0.1947 152.09)` | `--success` | `text-success` or HeroUI success status components | Communicates positive outcomes, confirmations, and completion states. |
| `warning` | `#F4A61E` | `#F6B84E` | `Light: oklch(78.19% 0.1595 73.61); Dark: oklch(82.03% 0.1396 77.62)` | `--warning` | `text-warning` for caution states | Indicates caution or actions that require attention but are not destructive. |
| `border` | `#DDDEE0` | `#28292A` | `Light: oklch(90.00% 0.0030 264.51); Dark: oklch(28.00% 0.0030 264.51)` | `--border` | `border-border` | Default border color for containers and interactive elements. |
...
| `scrollbar` | `#D3D4D6` | `#9FA0A2` | `Light: oklch(87.10% 0.0030 264.51); Dark: oklch(70.50% 0.0030 264.51)` | `--scrollbar` | Scrollbar thumb color | Scrollbar thumb color. |
| `segment` | `#FFFFFF` | `#464748` | `Light: = white; Dark: oklch(39.64% 0.0030 264.51)` | `--segment` | Segmented controls | Background for segmented controls. |
...
| `field-placeholder` | `#707276` | `#9EA0A4` | `= muted` | `--field-placeholder` | Field placeholder text color | Placeholder text color in form fields. |
...
| `danger-hover` | `#FF554D` | `#E1544E` | `danger / 90% + danger-foreground / 10%` | `--danger-hover` | Prefer the HeroUI token for danger-hover. | Hover state for danger backgrounds. |
| `danger-soft` | `rgba(255, 56, 54, 0.15)` | `rgba(219, 59, 58, 0.15)` | `danger / 15% + transparent` | `--danger-soft` | Prefer the HeroUI token for danger-soft. | Subtle danger background for soft emphasis. |
| `danger-soft-foreground` | `#A43530` | `#EB786F` | `Light: danger / 70% + foreground / 40%; Dark: danger / 80% + foreground / 30%` | `--danger-soft-foreground` | Prefer the HeroUI token for danger-soft-foreground. | Text color on danger-soft backgrounds. |
| `danger-soft-hover` | `rgba(255, 56, 54, 0.2)` | `rgba(219, 59, 58, 0.2)` | `danger / 20% + transparent` | `--danger-soft-hover` | Prefer the HeroUI token for danger-soft-hover. | Hover state for danger-soft backgrounds. |
...
| `success-hover` | `#18B65F` | `#18B65F` | `success / 90% + success-foreground / 10%` | `--success-hover` | Prefer the HeroUI token for success-hover. | Hover state for success backgrounds. |
| `success-soft` | `rgba(0, 202, 103, 0.15)` | `rgba(0, 202, 103, 0.12)` | `Light: success / 15% + transparent; Dark: success / 12% + transparent` | `--success-soft` | Prefer the HeroUI token for success-soft. | Subtle success background for soft emphasis. |
| `success-soft-foreground` | `#297847` | `#72D991` | `Light: success / 80% + foreground / 60%; Dark: success / 80% + foreground / 30%` | `--success-soft-foreground` | Prefer the HeroUI token for success-soft-foreground. | Text color on success-soft backgrounds. |
| `success-soft-hover` | `rgba(0, 202, 103, 0.2)` | `rgba(0, 202, 103, 0.16)` | `Light: success / 20% + transparent; Dark: success / 16% + transparent` | `--success-soft-hover` | Prefer the HeroUI token for success-soft-hover. | Hover state for success-soft backgrounds. |
...
| `warning-hover` | `#DB9626` | `#DDA64B` | `warning / 90% + warning-foreground / 10%` | `--warning-hover` | Prefer the HeroUI token for warning-hover. | Hover state for warning backgrounds. |
| `warning-soft` | `rgba(244, 166, 30, 0.15)` | `rgba(246, 184, 78, 0.12)` | `Light: warning / 15% + transparent; Dark: warning / 12% + transparent` | `--warning-soft` | Prefer the HeroUI token for warning-soft. | Subtle warning background for soft emphasis. |
| `warning-soft-foreground` | `#85602D` | `#F9CB85` | `Light: warning / 80% + foreground / 70%; Dark: warning / 80% + foreground / 30%` | `--warning-soft-foreground` | Prefer the HeroUI token for warning-soft-foreground. | Text color on warning-soft backgrounds. |
| `warning-soft-hover` | `rgba(244, 166, 30, 0.2)` | `rgba(246, 184, 78, 0.16)` | `Light: warning / 20% + transparent; Dark: warning / 16% + transparent` | `--warning-soft-hover` | Prefer the HeroUI token for warning-soft-hover. | Hover state for warning-soft backgrounds. |
...
| `field radius` | `8px` |  | `--field-radius` | Prefer HeroUI field components so this radius is applied automatically. | Corner radius basis for inputs, selects, text areas, and other form controls. |
...
| Token | Raw value | Formula / source | HeroUI variable | Tailwind / component equivalent | Purpose |
| --- | --- | --- | --- | --- | --- |
| `glass blur` | `Light: 13px; Dark: 44px` |  | `--glass-blur` | Use the glass theme components; avoid custom `backdrop-blur-*` overrides. | Backdrop blur amount for translucent glass surfaces. Glass theme only. |
